...
public class DBInterface {
    ...
    public static final String BD_TABLA = "deportes";
    ...
    public long insertarDeporte(String nombre, int check)
    {
    ...
    public Cursor obtenerDeportes(){
        return bd.query(BD_TABLA, new String []
                        { CAMPO_ID,CAMPO_NOMBRE, CAMPO_CHECK},
                null,null, null, null,
                null);
    }

    public long modificaDeporte(long id,String nombre, int check)
    {
    ...
    public long borrarDeporte(long id)
    {
